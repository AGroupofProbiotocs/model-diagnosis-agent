...
用法:
    python capture_gpu_mem_trace.py <gpu_script.py> [-o output.log] [--align32]
...
def main():
    ...
    parser.add_argument("--align32", action="store_true", help="使用 32 字节对齐测试分支")
    ...
    try:
        events, api_name = run_with_profiler(args.gpu_script, use_32align=args.align32)
